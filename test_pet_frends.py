#Добавление неявных ожиданиий всех элементов (фото, имя питомца, возраст питомца)
# в написанные тесты по проверке карточек питомцев.
...
def test_pet_frends():
    ...
    # Проверка перехода на страницу всех питомцев
